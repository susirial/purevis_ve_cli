...
- 修订人：`GPT-5.4`
- 主要变更：
  - 重构全文层级，统一为“简介、安装、快速开始、功能、命令、配置、FAQ、ChangeLog”主结构
  - 新增“核心功能”表格，系统梳理多智能体、状态管理、风格治理、分镜设计、媒体生成、视觉审核等能力
  - 新增“命令总览”，按“数据查询类、可视化类、系统管理类”分类整理命令原型、参数、示例与返回说明
  - 增补命令解析机制、工具调用流程、错误处理与恢复策略说明
  - 优化 `.env` 配置示例与排版，将 `AK/SK` 预留说明降级为引用正文，减少视觉干扰
